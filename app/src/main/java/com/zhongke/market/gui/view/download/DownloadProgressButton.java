...
//        registerSoftManagerFinisgBroadCast(context);
    ...
    private void initLayout() {
        ...
        downloadbtn.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
...
//                .addAction(Constants.ACTION_SOFTWARE_MANAGER_GET_UPDATE_LIST_FROM_NETWORK_FINISH);
    ...
    protected void onAttachedToWindow() {
        Log.e("llj", "DownloadProgressButton,onAttachedToWindow !!!");
    ...
    protected void onDetachedFromWindow() {
        Log.e("llj", "DownloadProgressButton,onDetachedFromWindow() !!!");
        onDestory();
