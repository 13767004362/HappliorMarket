...
import com.zhongke.market.db.DBHelp.Columns;
...
public class SoftwareManagerDB {
    ...
    public Hashtable<String, UpdateAppInfo> queryAll() {
        ...
        try {
            ...
            cursor = db.query(DBHelp.Columns.TABLE_NAME, null, null, null, null, null,
                    null);
    ...
    public void insertList(Map<String, UpdateAppInfo> appInfos) {
        SQLiteDatabase db = dbHelp.getWritableDatabase();
        Iterator<Map.Entry<String, UpdateAppInfo>> it = appInfos.entrySet()
                .iterator();
        while (it.hasNext()) {
            Map.Entry<String, UpdateAppInfo> entry = it.next();
    ...
    public int updateAppInfos(Hashtable<String, UpdateAppInfo> infos) {
        SQLiteDatabase db = dbHelp.getWritableDatabase();
        int count = 0;
        for (Map.Entry<String, UpdateAppInfo> entry : infos.entrySet()) {
